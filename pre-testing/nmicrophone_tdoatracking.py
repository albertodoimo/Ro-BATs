...
# threshold = None
# vsound = None
# highpass_coeffs = None
# 
# audio_queue = None 
# chunknum = None
# 
# source_solutions = None
# 
# def get_xyz_tristar():
#     pass
# 
...
# micxyz = np.loadtxt('micxyz_copia.csv', delimiter=';')
print(micxyz)
...
orig_sources = np.loadtxt('sources_copia.csv', delimiter=';')
print(orig_sources)
...
# camdistance = 8 
# w.setCameraParams(distance=camdistance, azimuth=0, elevation=60)
