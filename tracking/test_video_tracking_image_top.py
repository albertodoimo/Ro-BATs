...
def draw_trajectories_on_video(input_video_path, output_video_path, aruco_tracker, overlay_img_path):
    ...
    while True:
        ...
        overlay_img = cv2.resize(overlay_img, (500,500))  # Adjust size as needed
        #print(overlay_img.shape)
...
input_video_path = '/Users/alberto/Desktop/dynamic obstacle avoidance.mp4'  # replace with your input video path
output_video_path = '/Users/alberto/Desktop/dynamic obstacle avoidance_tracked.mp4'  # replace with your desired output video path
overlay_img_path = '/Users/alberto/Desktop/ROBAT LOGO.png'  # replace with your overlay image path
