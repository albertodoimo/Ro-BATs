...
video_out_signal = video_out_signal[fs*5:fs*10]  # take only one channel
...
robat_238_raw_audio, fs = sf.read(os.path.join(dir, 'data','134.34.226.238', 'MULTIWAV_134.34.226.238_2025-08-15__16-34-38.wav'))
...
peaks, properties = signal.find_peaks(filtered_envelope, prominence=5)
...
timestamps_file = os.path.join(dir, 'data', '134.34.226.238', 'TIMESTAMPS_134.34.226.238_2025-08-15__16-34-38.csv')
timestamps = []
