...
class Aruco_tracker:
    def __init__(self, cam_id=-1, monitor_id=0, debug=True, debug_stream=True, frame_width=1920, frame_height=1080, crop_img=False, num_tags=15, decision_margin=20, record_stream=True, publish_pos=False, print_pos=True, detect_arena=False):
